                ...
                <Container >
                    ...
                    <Navbar.Collapse id="navbarScroll">
                        <Nav className="" navbarScroll>
                            <NavDropdown style={{ background: "white", borderTopLeftRadius: '8px', borderBottomLeftRadius: "8px", padding: '0 5px' }} title="All" id="navbarScrollingDropdown">
                        ...
                        <div style={{ display: 'flex' }}>
                            ...
                            <div style={{ display: 'flex', alignItems: 'center' }}>
                                <a style={{ display: 'flex', textDecoration: 'none', marginLeft: '10px', color:'white' }} class="ipc-btn ipc-btn--single-padding ipc-btn--center-align-content ipc-btn--default-height ipc-btn--core-baseAlt ipc-btn--theme-baseAlt ipc-btn--on-textPrimary ipc-text-button" role="button" tabindex="0" aria-disabled="false" href="/list/watchlist?ref_=nv_usr_wl_all_0">
                                    ...
                                    <span class="ipc-btn__text">Watchlist</span>
                                </a>
                            </div>
                        ...
                        <Nav className="" navbarScroll>
                            <NavDropdown style={{ borderTopLeftRadius: '8px', borderBottomLeftRadius: "8px", padding: '0 5px' }} title=<span style={{ color: 'white' }}>EN</span> id="navbarScrollingDropdown">
                                <NavDropdown.Item href="#action3">Action</NavDropdown.Item>
                                <NavDropdown.Item href="#action4">Another action</NavDropdown.Item>
                                <NavDropdown.Divider />
                                <NavDropdown.Item href="#action5">Something else here</NavDropdown.Item>
